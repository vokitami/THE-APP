...
export default function Register(){
  ...
  <header>
    ...
    <div className='h-[78%] relative flex w-full items-center justify-center'> 
        ...
        <h1 className='text-2xl mb-10'>Register in to the app</h1>
        <div class='flex flex-col border-1 p-1 my-5 rounded-[5px] w-full border-zinc-600'>
        <label className='text-zinc-600 p-1' htmlFor='text'>Name</label>
        <input className=' h-[30px] outline-0 p-1 mb-1 mx-' type="text" name="name" required value={name} onChange={e => setName(e.target.value)}/>
        </div>
        <div class='flex flex-col border-1 p-1 my-5 rounded-[5px] w-full border-zinc-600'>
        ...
        <div class='flex flex-col border-1 p-1 my-5 rounded-[5px] w-full border-zinc-600'>
            ...
            <input className='h-[30px] outline-0 mb-1 mx-1 ' type="password" name="password" required value={password} onChange={e => setPassword(e.target.value)}/>
        </div>
